...
namespace ISIInspection.MieTrak
{
    ...
    public partial class MachineMaintenanceScheduleRequestStatu
    {
        public MachineMaintenanceScheduleRequestStatu()
        {
            this.MachineMaintenanceScheduleRequests = new HashSet<MachineMaintenanceScheduleRequest>();
        }
    
        public int MachineMaintenanceScheduleRequestStatusPK { get; set; }
